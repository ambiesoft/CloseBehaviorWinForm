...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->chkPreventDefaultWM_ENDESSSION->TabIndex = 300;
			...
			this->lblLogFile->Location = System::Drawing::Point(12, 9);
			this->lblLogFile->Name = L"lblLogFile";
			this->lblLogFile->Size = System::Drawing::Size(47, 13);
			this->lblLogFile->TabIndex = 100;
...
#pragma endregion
	...
	private:
		System::Void FormMain_Load(System::Object^ sender, System::EventArgs^ e) {
			UpdateDialog();
			String^ logFile = Path::Combine(Path::GetDirectoryName(Application::ExecutablePath),
				Path::GetFileNameWithoutExtension(Application::ExecutablePath) + ".txt");
		...
		System::Void chkPreventDefaultWM_ENDESSSION_CheckedChanged(System::Object^ sender, System::EventArgs^ e) {
			UpdateDialog();
		}
	};
}
